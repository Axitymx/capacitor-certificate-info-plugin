...
export declare type CertFilename = {
    /**
     * Name of the certification file
     */
    filename: string;
};
export declare type CertExpiration = {
    /**
     * Expiration date in ISO 8601 format
     */
    expirationDate: string;
};
export declare type CertExpirations = {
    /**
     * List of expiration dates in ISO 8601 format
     */
    expirationDates: string[];
};
export declare type CertDate = {
    /**
     * Date in format ISO 8601
     */
    date: string;
};
export declare type CertValid = {
    /**
